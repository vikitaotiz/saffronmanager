            ...
            <div class="card rounded-0">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        {{-- <a href="{{ route('formbuilder::submissions.index') }}" class="btn btn-primary float-md-right btn-sm" title="Back To My Submissions">
                            <i class="fa fa-arrow-left"></i> 
                        </a> --}}
                    </h5>
                </div>

                <form action="{{ route('formbuilder::submissions.update', $submission->id) }}" method="POST" id="submitForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
