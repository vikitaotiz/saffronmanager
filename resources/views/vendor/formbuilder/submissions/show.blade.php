...
<div class="panel panel-success">
        <div class="panel-heading">
              <div class="row">
                <div class="col-md-4">
                        <a href="{{ route('formbuilder::forms.submissions.index', $submission->form->id) }}" class="btn btn-sm btn-success" title="Back To Submissions">
                ...
                <div class="col-md-4">
                        @can('user_management_access')
                                <a href="{{ route('formbuilder::submissions.edit', $submission->id) }}" class="btn btn-success btn-sm" title="Edit this submission">
